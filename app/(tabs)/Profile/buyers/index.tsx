...
const styles = StyleSheet.create({
  ...
  selectedPreview: { marginHorizontal: 24, marginBottom: 12, padding: 10, borderRadius: 12, borderWidth: 1 },
  ...
  selectedPreviewLabel: { fontSize: 11, marginBottom: 2 },
  selectedPreviewValue: { fontSize: 14, fontWeight: '600' },
